        ...
        <div class="festival_technologies">
            <div class="festival_technology_block">
                <div class="festival_technology">
                    ...
                    <?php if($count > 0): ?><img src="<?php echo e(asset('img/icons/arrow-down.png')); ?>" alt=""><?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\localhost\festival\resources\views/festival.blade.php ENDPATH**/ ?>